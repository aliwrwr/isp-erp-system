...
export declare class WhatsappService implements OnModuleInit, OnModuleDestroy {
    ...
    private get crashMarkerPath();
    private writeCrashMarker;
    private clearCrashMarker;
    private checkCrashMarker;
    onModuleDestroy(): Promise<void>;
    private clearInitTimeout;
    private getPuppeteerExecutablePath;
    initializeClient(force?: boolean, isAutoRetry?: boolean): Promise<void>;
