...
const systemMenus: Record<string, { label: string; icon: string; route: string }[]> = {
  internet: [
    ...
    { label: 'المجموعات', icon: 'fas fa-layer-group', route: '/internet/groups' },
    { label: 'الصلاحيات', icon: 'fas fa-key', route: '/internet/permissions' },
...
const routePermissions: Record<string, string> = {
  ...
  '/internet/groups': 'internet.groups',
